...
crafting.removeByOutput(item('thermalfoundation:material:133'))
...
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 128))
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 129))
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 131))
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 133))
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 132))
mods.tconstruct.casting_table.removeByOutput(item('thermalfoundation:material', 160))
